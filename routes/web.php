...
Route::middleware(['auth', TeacherMiddleware::class])->prefix('teacher')->group(function () {
    Route::get('/dashboard', [TeacherMainController::class, 'index'])->name('teacher.dashboard');

    // Students
    Route::get('/students/create', [TeacherStudentController::class, 'create'])->name('teacher.students.create');
    Route::post('/students', [TeacherStudentController::class, 'store'])->name('teacher.student.store');
    Route::get('/students/show', [TeacherStudentController::class, 'showAllStudents'])->name('teacher.students.index');
    Route::get('/students/{student}', [TeacherStudentController::class, 'show'])->name('teacher.students.show');
    Route::get('/students/{student}/edit', [TeacherStudentController::class, 'edit'])->name('teacher.students.edit');
    Route::patch('/students/{student}', [TeacherStudentController::class, 'update'])->name('teacher.students.update');
...
Route::middleware(['auth', StudentMiddleware::class])->prefix('student')->group(function () {
    Route::get('/dashboard', [StudentStdController::class, 'index'])->name('student.dashboard');
